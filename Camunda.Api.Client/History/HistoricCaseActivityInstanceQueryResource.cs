...
public class HistoricCaseActivityInstanceQueryResource
{
  ...
  private readonly HistoricCaseActivityInstanceQuery _query;
  ...
  /// </summary>
  public Task<List<HistoricCaseActivityInstance>> List() 
    => _api.GetList(_query.CaseInstanceId, null, null);
  ...
  public Task<List<HistoricCaseActivityInstance>> List(int firstResult, int maxResults) 
    => _api.GetList(_query.CaseInstanceId, firstResult, maxResults);
