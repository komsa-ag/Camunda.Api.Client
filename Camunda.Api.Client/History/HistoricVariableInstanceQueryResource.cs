...
public class HistoricVariableInstanceQueryResource
{
  ...
  private readonly HistoricVariableInstanceQuery _query;
  ...
  /// </summary>
  public Task<List<HistoricVariableInstance>> List()
    => _api.GetList(_query, null, null);
  ...
  public Task<List<HistoricVariableInstance>> List(int firstResult, int maxResults, bool deserializeValues = true)
    => _api.GetList(_query, firstResult, maxResults, deserializeValues);
