...
{
  private readonly IHistoricProcessDefinitionRestService _api;
  ...
  /// <returns></returns>
  public Task<List<HistoricActivityStatisticsResult>> GetHistoricActivityStatistics(
    string id, HistoricActivityStatistics historicActivityStatistics)
  ...
  /// <returns></returns>
  public Task<List<CleanableProcessInstanceReportResult>> GetCleanableProcessInstanceReport(
    CleanableProcessInstanceReport cleanableProcessInstanceReport)
  ...
  /// <returns></returns>
  public async Task<int> GetCleanableProcessInstanceReportCount(
