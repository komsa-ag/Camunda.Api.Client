...
public class HistoricDecisionInstanceQuery : QueryParameters
{
    ...
    public List<string> DecisionInstanceIds = new();
    ...
    public List<string> DecisionDefinitionIds = new();
    ...
    public List<string> DecisionDefinitionKeys = new();
    ...
    public List<string> ActivityIds = new();
