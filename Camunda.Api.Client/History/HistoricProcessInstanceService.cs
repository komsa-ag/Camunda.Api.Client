...
public class HistoricProcessInstanceService
{
  ...
  internal HistoricProcessInstanceService(IHistoricProcessInstanceRestService api) => _api = api;
  ...
  public HistoricProcessInstanceResource this[string processInstanceId] 
    => new(_api, processInstanceId);
  ...
  /// </summary>
  public Task<BatchInfo> Delete(DeleteHistoricProcessInstances deleteHistoricProcessInstances) 
    => _api.DeleteAsync(deleteHistoricProcessInstances);
  ...
  public Task<List<DurationReportResult>> GetDurationReport(HistoricProcessInstanceReport historicProcessInstanceReport) 
    => _api.GetDurationReport(historicProcessInstanceReport);
}
