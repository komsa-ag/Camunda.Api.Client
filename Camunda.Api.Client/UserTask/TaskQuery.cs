...
public class TaskQuery
{
    ...
    public List<string> ProcessInstanceBusinessKeys = new();
    /// <summary>
    ...
    public List<string> ProcessDefinitionKeys = new();
    /// <summary>
    ...
    public List<string> ActivityInstanceIds = new();
    /// <summary>
    ...
    public List<string> TaskDefinitionKeys = new();
    /// <summary>
    ...
    public List<string> TenantIds = new();
    /// <summary>
    ...
    /// </summary>
    public List<SortingInfo<TaskSorting>> Sorting = new();
