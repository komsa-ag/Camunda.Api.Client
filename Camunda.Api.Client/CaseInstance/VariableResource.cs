...
{
  private readonly string _caseInstanceId;
  ...
  public Task<VariableValue> Get(string variableName, bool deserializeValue = true) 
    => _api.GetVariableValue(_caseInstanceId, variableName, deserializeValue);
  /// <summary>
