...
public class LocalVariableResource : IVariableResource
{
  ...
  public Task<Dictionary<string, VariableValue>> GetAll(bool deserializeValues = true)
    => _api.GetLocalVariables(_executionId, deserializeValues);
  /// <summary>
  ...
  public Task<VariableValue> Get(string variableName, bool deserializeValue = true)
    => _api.GetLocalVariable(_executionId, variableName, deserializeValue);
  /// <summary>
  ...
  public async Task<HttpContent> GetBinary(string variableName)
    => (await _api.GetBinaryLocalVariable(_executionId, variableName)).Content;
  /// <summary>
  ...
  public Task Set(string variableName, VariableValue variable)
    => _api.PutLocalVariable(_executionId, variableName, variable);
  /// <summary>
  /// Sets the serialized value for a binary variable or the binary value for a file variable.
  /// </summary>
  public Task SetBinary(string variableName, BinaryDataContent data, BinaryVariableType valueType)
    => _api.SetBinaryLocalVariable(_executionId, variableName, data, new ValueTypeContent(valueType.ToString()));
  /// <summary>
  ...
  public Task Delete(string variableName)
    => _api.DeleteLocalVariable(_executionId, variableName);
  /// <summary>
  ...
  public Task Modify(PatchVariables patch)
    => _api.ModifyLocalVariables(_executionId, patch);
