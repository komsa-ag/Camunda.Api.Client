...
public class CorrelationMessage
{
  ...
  /// </summary>
  public Dictionary<string, VariableValue> CorrelationKeys = [];
  /// <summary>
  ...
  /// </summary>
  public Dictionary<string, VariableValue> ProcessVariables = [];
  /// <summary>
  ...
  {
    ProcessVariables = (ProcessVariables ?? []).Set(name, value);
    return this;
  }

  public CorrelationMessage SetCorrelationKey(string name, object value)
  {
    CorrelationKeys = (CorrelationKeys ?? []).Set(name, value);
    return this;
  }
