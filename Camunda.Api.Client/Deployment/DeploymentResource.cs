...
public class DeploymentResource
{
  ...
  public DeploymentResourcesResource Resources => new(_api, _deploymentId);
  ...
  /// </remarks>
  public Task<DeploymentInfo> Redeploy(RedeploymentInfo redeployment)
    => _api.Redeploy(_deploymentId, redeployment);
  ...
  public Task Delete(bool cascade = false, bool skipCustomListeners = false, bool skipIoMappings = false)
    => _api.Delete(_deploymentId, cascade, skipCustomListeners, skipIoMappings);
