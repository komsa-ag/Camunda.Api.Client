...
public abstract class QueryParameters
{
    public static implicit operator QueryDictionary(QueryParameters query)
    {
        ...
        Dictionary<string, JToken> json = JsonConvert.DeserializeObject<Dictionary<string, JToken>>(JsonConvert.SerializeObject(query, CamundaClient.JsonSerializerSettings), CamundaClient.JsonSerializerSettings);
