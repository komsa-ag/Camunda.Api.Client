...
{
  private readonly ICaseExecutionRestService _api;
  private readonly string _caseExecutionId;
  ...
  /// </summary>
  public Task Start(CaseExecutionStart start) 
    => _api.StartExecution(_caseExecutionId, start);
  ...
  /// </summary>
  public Task Complete(CaseExecutionComplete complete) 
    => _api.CompleteExecution(_caseExecutionId, complete);
  ...
  /// </summary>
  public Task Disable(CaseExecutionDisable disable) 
    => _api.DisableExecution(_caseExecutionId, disable);
  ...
  /// </summary>
  public Task ReEnable(CaseExecutionReEnable reEnable) 
    => _api.ReEnableExecution(_caseExecutionId, reEnable);
  ...
  /// </summary>
  public Task Terminate(CaseExecutionTerminate terminate) 
    => _api.TerminateExecution(_caseExecutionId, terminate);
}