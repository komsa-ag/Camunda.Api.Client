...
public class VariableResource : IVariableResource
{
  ...
  public Task<Dictionary<string, VariableValue>> GetAll(bool deserializeValues = true)
    => _api.GetVariables(_processInstanceId, deserializeValues);
  ...
  public Task<VariableValue> Get(string variableName, bool deserializeValue = true)
    => _api.GetVariable(_processInstanceId, variableName, deserializeValue);
  ...
  public async Task<HttpContent> GetBinary(string variableName)
    => (await _api.GetBinaryVariable(_processInstanceId, variableName)).Content;
  ...
  public Task Set(string variableName, VariableValue variable)
    => _api.PutVariable(_processInstanceId, variableName, variable);
  ...
  public Task SetBinary(string variableName, BinaryDataContent data, BinaryVariableType valueType)
    => _api.SetBinaryVariable(_processInstanceId, variableName, data, new ValueTypeContent(valueType.ToString()));
  ...
  public Task Delete(string variableName)
    => _api.DeleteVariable(_processInstanceId, variableName);
  ...
  public Task Modify(PatchVariables patch)
    => _api.ModifyVariables(_processInstanceId, patch);
