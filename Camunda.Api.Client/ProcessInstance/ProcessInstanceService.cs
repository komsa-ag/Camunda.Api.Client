...
public class ProcessInstanceService
{
  ...
  public ProcessInstanceResource this[string processInstanceId]
  ...
  /// </summary>
  public Task UpdateSuspensionState(ProcessInstanceSuspensionState state)
    => _api.UpdateSuspensionState(state);

  /// <summary>
  /// Deletes multiple process instances asynchronously (batch).
  /// </summary>
  public Task<BatchInfo> Delete(DeleteProcessInstances deleteProcessInstances)
    => _api.DeleteProcessInstanceAsync(deleteProcessInstances);

  /// <summary>
  /// Create a batch to set retries of jobs associated with given processes asynchronously.
  /// </summary>
  public Task<BatchInfo> SetRetriesByProcess(JobRetriesByProcess setJobRetries)
    => _api.SetRetriesByProcess(setJobRetries);
}